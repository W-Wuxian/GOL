...
help :
	...
	@echo "make run filepath : to give the Custom pattern initialization using a file"
	@echo "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||"
	@echo "EXAMPLES:"
	@echo "1/ make clean3 all run DEBUG=yes CASE=3 myfile.txt"
	@echo "2/ make clean3 && make all DEBUG=yes CASE=3 && make run DEBUG=yes file.txt"
	@echo "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||"
	@echo "**************************************************************************"
